...
<body id="page-top">
  ...
  <nav class="navbar navbar-expand navbar-dark bg-dark static-top">
    ...
    <a class="navbar-brand mr-1" href="<?php echo base_url() . 'administrator/cekuser' ?>">TOKO KU</a>
    ...
    <li class="nav-item dropdown no-arrow">
      <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
        ...
        <span>Hai,<?php echo $this->session->userdata('nama'); ?> </span>
      </a>
                  ...
                  <footer class="sticky-footer">
                    <div class="container my-auto">
                      <div class="copyright text-center my-auto">
                        <span>Copyright© 2022 <a href="#" target="_blank">Amel dan Fira</a> | <a href="#" title="" target="_blank">TOKO KU</a></span>
                      </div>
                    </div>
                  </footer>
                  <!-- /#wrapper -->
